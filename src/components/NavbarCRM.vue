<template>
  <section class="navbar" id="navbar">
    <div class="navbar-container">
      <div class="top-line">
        ...
        <div id="scroll-container">
          <div id="scroll-text">
            <span id="sc-text"> Welcome to Abhitprints. 🎉 </span> &nbsp;
          ...
          <div class="nav-icons">
            <!-- <div class="nav-icon mob-icon">
              ...
              <div class="mob-search-modal" v-if="formVar.searchModal">
                ...
                <div class="close-btn">
                  <div
                    class="icon"
                    @click.prevent="formVar.searchModal = false"
                  >
              ...
              <div class="noti-popup" :class="formVar.notiList ? 'noti-active' : 'noti-inactive'">
                ...
                <div class="noti-body">
                  ...
                  <router-link to="#" class="list-item" @click.prevent="closeNotiList()">
                    ...
                    <div class="details">
                      <h6 class="title">New Customers</h6>
                      <div class="sub-title text-light-grey">
                        5 new user registered
                      </div>
                    </div>
                ...
                <div class="noti-footer">
                  <router-link to="/crm/notifications" class="view-all text-center" @click.prevent="closeNotiList()">
                    View All
                  </router-link>
                </div>
              </div>
            </div> -->
            <router-link to="/crm/profile" class="nav-icon">
              <div class="icon tooltip-wrapper">
                <icon-user></icon-user>
                <div class="tooltip">Profile</div>
              </div>
            </router-link>
            <div class="nav-icon" @click="openConfirmModal">
              <div class="icon tooltip-wrapper">
                <icon-exit></icon-exit>
            ...
            <!-- <div class="nav-icon" v-click-outside="closeAccList">
              ...
              <div class="noti-popup" :class="formVar.accList ? 'noti-active' : 'noti-inactive'">
                ...
                <div class="menu-body">
                  <router-link to="/crm/profile" class="body-item" @click.prevent="closeAccList">
                    <div class="icon">
                      <icon-user></icon-user>
                    </div>
                    <div class="title">Profile</div>
                  </router-link>
                  <router-link to="/crm/default-setting" class="body-item" @click.prevent="closeAccList">
                    <div class="icon">
                      <icon-setting></icon-setting>
                    </div>
                    <div class="title">Setting</div>
                  </router-link>
                  <div class="body-item" @click.prevent="closeAccList">
                    <div class="icon">
                      <icon-info></icon-info>
                    </div>
            ...
            <!-- <div class="nav-icon" v-click-outside="closeMenuList">
              ...
              <div class="noti-popup" :class="formVar.menuList ? 'noti-active' : 'noti-inactive'">
                ...
                <div class="menu-body">
                  ...
                  <router-link to="/crm/faq" class="body-item" @click.prevent="closeMenuList()">
                    <div class="icon">
                      <icon-info></icon-info>
                    </div>
                    <div class="title">FAQ</div>
                  </router-link>
                  <router-link to="/crm/feedback" class="body-item" @click.prevent="closeMenuList()">
                    <div class="icon">
                      <icon-info></icon-info>
                    </div>
                  ...
                  <router-link to="/crm/pages" class="body-item" @click.prevent="closeMenuList()">
                    <div class="icon">
                      <icon-info></icon-info>
                    </div>
                    <div class="title">Pages</div>
                  </router-link>
                  <router-link to="/crm/designation" class="body-item" @click.prevent="closeMenuList()">
                    <div class="icon">
                      <icon-info></icon-info>
                    </div>
                    <div class="title">Designation</div>
                  </router-link>
                  <router-link to="/crm/staff" class="body-item" @click.prevent="closeMenuList()">
                    <div class="icon">
                      <icon-info></icon-info>
                    </div>
                    <div class="title">Staff</div>
                  </router-link>
                  <router-link to="/crm/organization" class="body-item" @click.prevent="closeMenuList()">
                    <div class="icon">
    ...
    >
      ...
      <h4 class="text-gree">Are you sure want to Logout?</h4>
