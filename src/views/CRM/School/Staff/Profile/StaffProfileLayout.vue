    ...
    <div class="container">
      <div class="left-card card">
        ...
        <div class="bottom-links bottom-links-desk">
          ...
          <router-link
            :to="
              '/crm/school-staff-class-students?id=' +
              formVar.staffAccountId +
              '&settingId=' +
              formVar.settingId
            "
          ...
          <router-link
            :to="
              '/crm/school-staff-department?id=' +
              formVar.staffAccountId +
              '&settingId=' +
              formVar.settingId
            "
          ...
          <!-- <router-link
            :to="
              '/crm/school-staff-time-table?id=' +
              formVar.staffAccountId +
              '&settingId=' +
              formVar.settingId
            "
