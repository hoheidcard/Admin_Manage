    ...
    <div class="container">
      <div class="left-card card">
          ...
          <div class="flex">
            <div class="info w-50">
              ...
              <div class="about flex">
                ...
                <div class="desc">
                  <strong>:</strong> &nbsp; {{ storeVar.updated?.staffDetail?.name }}
                </div>
              </div>
              <div class="about flex">
        ...
        <div class="bottom-links bottom-links-desk">
          <router-link
            :to="`/crm/school/setting/class-list?id=${formVar.organizationId}&settingId=${formVar.organizationSettingId}`"
            class="profile-link"
          >
          ...
          <router-link
            :to="`/crm/school/setting/division-list?id=${formVar.organizationId}&settingId=${formVar.organizationSettingId}`"
            class="profile-link"
          >
          ...
          <router-link
            :to="`/crm/school/setting/books-category?id=${formVar.organizationId}&settingId=${formVar.organizationSettingId}`"
            class="profile-link"
          >
          ...
          <router-link
            :to="`/crm/school/setting/department?id=${formVar.organizationId}&settingId=${formVar.organizationSettingId}`"
            class="profile-link"
          >
          ...
          <router-link
            :to="`/crm/school/setting/designation?id=${formVar.organizationId}&settingId=${formVar.organizationSettingId}`"
            class="profile-link"
          >
          ...
          <router-link
            :to="`/crm/school/setting/house-zone?id=${formVar.organizationId}&settingId=${formVar.organizationSettingId}`"
            class="profile-link"
          >
          ...
          <router-link
            :to="`/crm/school/setting/subject?id=${formVar.organizationId}&settingId=${formVar.organizationSettingId}`"
            class="profile-link"
          >
          ...
          <router-link
            :to="`/crm/school/setting/permission?id=${formVar.organizationId}&settingId=${formVar.organizationSettingId}`"
            class="profile-link"
          >
          ...
          <router-link
            :to="`/crm/school/setting/csv-download?id=${formVar.organizationId}&settingId=${formVar.organizationSettingId}`"
            class="profile-link"
          >
          ...
          <router-link
            :to="`/crm/school/setting/staff-csv-download?id=${formVar.organizationId}&settingId=${formVar.organizationSettingId}`"
            class="profile-link"
          >
          ...
          <!-- <router-link :to="`/crm/school/setting/import-student?id=${formVar.organizationId}&settingId=${formVar.organizationSettingId}`" class="profile-link">
