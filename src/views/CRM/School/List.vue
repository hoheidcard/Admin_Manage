          ...
          <div class="right">
            ...
            <div class="icons">
              <div
                ...
                @click.prevent="navigate(null, '/crm/add-school')"
              >
                <icon-plus></icon-plus>
            ...
            <table class="table">
              ...
              <tbody>
                ...
                >
                  ...
                  <td>
                    <router-link
                      :to="`/crm/school/setting/class-list?id=${item.id}&settingId=${item.settingId}`"
                  ...
                  <!-- <td>
                    <div class="icons">
                      <div class="icon tooltip-wrapper" @click.prevent="navigate(null, '/crm/add-school')">
                        {{ item.name }}
                        <div class="tooltip">
                  ...
                  <td>
                    <div class="option-btns">
                      <div
                        class="icon tooltip-wrapper"
                        @click="navigate(item.id, '/crm/edit-school')"
                      >
                        <icon-edit></icon-edit>
