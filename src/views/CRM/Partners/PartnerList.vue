      ...
      <div class="table-card card">
        ...
        <div class="table-body p-16">
                ...
                <tr v-for="(item, index) in storeVar.partnersData" :key="index">
                  ...
                  <td>
                    <div class="option-btns">
                      <div class="icon tooltip-wrapper" @click="navigate(item.id, '/crm/edit-partners')">
                        <icon-edit></icon-edit>
                      ...
                      <div class="icon tooltip-wrapper" @click.prevent="
                        navigaters(
                          item.accountId,item.settingId,
                          '/crm/sub-partners'
                        )
                        ">
                        <icon-menu></icon-menu>
          ...
          <div class="table-footer" v-if="storeVar.partnersData?.length > 0">
            <Pagination :currentPage="formVar.currentPage" :totalItem="storeVar.totalPartners"
