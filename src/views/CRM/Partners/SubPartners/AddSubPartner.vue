    ...
    <div class="container">
      <div class="card">
        <div class="heading-edit">
          <h3 class="heading">Add Sub Partners</h3>
        </div>
...
onBeforeMount(() => {
  if (route.query.id) {
    formVar.subPartnersAccountId = route.query.id;
  }
});
/* Lifecycle/Hooks */
...
function addPartners() {
  ...
  store.dispatch("SubPartners/addSubPartners", {
    ...
    accountId: formVar.subPartnersAccountId,
  });
}
function resetForm() {
