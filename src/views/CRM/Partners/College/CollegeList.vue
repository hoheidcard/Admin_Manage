        ...
        <div class="table-header">
          <div class="left">
            <div class="title-row">
              ...
              <div class="titles">
                <div class="sub-title">college : List</div>
                <h5 class="main-title">Our college</h5>
              </div>
            </div>
          </div>
          <div class="right">
            ...
            <div class="icons">
              <div
                ...
                @click.prevent="
                  navigate(route.query.id, '/crm/partners/add-college')
                "
              >
                <icon-plus></icon-plus>
                <div class="tooltip">Add College</div>
              </div>
            </div>
          </div>
        </div>
