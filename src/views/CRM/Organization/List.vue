        ...
        <div class="table-header">
          <div class="left">
            <div class="title-row">
              ...
              <div class="titles">
                <div class="sub-title">Organization : List</div>
                <h5 class="main-title">Our Organization</h5>
              </div>
            </div>
          </div>
          <div class="right">
            ...
            <div class="icons">
              <div
                ...
                @click.prevent="navigate(null, '/crm/add-organization')"
              >
                <icon-plus></icon-plus>
                <div class="tooltip">Add Organization</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <table class="table">
              ...
              <tbody>
                ...
                >
                  ...
                  <td>
                    <router-link
                      :to="`/crm/organization/setting/department?id=${item.id}&settingId=${item.settingId}`"
                  ...
                  <!-- <td>
                    <div class="icons">
                      <div class="icon tooltip-wrapper" @click.prevent="navigate(null, '/crm/add-organization')">
                        {{ item.name }}
                        <div class="tooltip">
                      ...
                      <div
                        ...
                        @click.prevent="
                          navigaters(
                            item.id,
                            item.settingId,
                            '/crm/organization/setting/designation?'
                          )
                        "
                      >
