    ...
    <div class="table-header">
      <div class="left">
        <div class="title-row">
          ...
          <div class="titles">
            <div class="sub-title">Book Category : List</div>
            <h5 class="main-title">Our Book Category</h5>
          </div>
        </div>
      </div>
      <div class="right">
        ...
        <div class="icons">
          <div class="icon tooltip-wrapper" @click.prevent="opencreateModal">
            <icon-plus></icon-plus>
            <div class="tooltip">Add Book Category</div>
          </div>
        </div>
      </div>
    </div>
  ...
  >
    <template v-slot:header>
      <div class="title" showHeader="true">
        {{ formVar.editMode ? "Update Book Category" : "Add Book Category" }}
      </div>
