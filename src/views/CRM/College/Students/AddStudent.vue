<template>
  <section class="add-student">
          ...
          <form action="" class="form">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="form-item mb-16 col-5">
                  <input type="text" placeholder="Previous College Name" />
                  <!-- <div class="err-msg">Please enter previous college name</div> -->
                </div>
                <div class="form-item mb-16 col-5">
              ...
              <div class="row">
                <div class="form-item col-25 align-center gap-16">
    ...
    >
      ...
      <h4 class="text-gree mb-10-i">Student Added Successfully</h4>
